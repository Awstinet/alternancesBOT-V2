...
## A ajouter:
-> Toutes les commandes pour modifier les variables d'environnements telles que la localisation, le temps entre 2 relances / scrappings, les sites ajoutés, etc
-> Commandes type "panels admins" comme ajouter des filtres, 
